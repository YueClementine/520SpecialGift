class PuzzleScene extends Phaser.Scene {
    constructor() {
        ...
        this.version = "1.8"; // 更新版本号
        console.log("PuzzleScene构造函数执行，版本：", this.version, "- 整齐网格布局");
    }
    ...
    create() {
        ...
        // 添加标题
        this.add.text(width / 2, 30, '我们的回忆拼图', {
            fontSize: '32px',
            fill: '#ffffff',
            fontFamily: 'Arial',
            stroke: '#000000',
        ...
        // 添加说明
        this.add.text(width / 2, 70, '点击并拖动拼图碎片，重现我们美好的瞬间', {
            fontSize: '20px',
            fill: '#ffffff',
            fontFamily: 'Arial',
            stroke: '#000000',
